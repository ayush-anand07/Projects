...
# def compare_A():  
#     global score
#     a_dict_followcount = a_dict["follower_count"]
#     b_dict_followcount = b_dict["follower_count"]
#     if a_dict_followcount > b_dict_followcount :
#         score+=1
...
#     if b_dict_followcount > a_dict_followcount:
#         score+=1
#         print(f"You are right. current score = {score}")
#         return True
#     else:
...
#     print(a_dict)
#     print(b_dict)
#     user_input = input("Who has more follwers? Type 'A' or 'B' ")
#     if user_input == "A" :
#        a =  compare_A()   
#     if user_input == "B":
#        a =  compare_B()
